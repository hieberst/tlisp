...
Sei \path{/storage/sdCard0} der interne Speicher und sei
\path{/storage/extSdCard/tlisp} das Installationsverzeichnis von TLISP.
\begin{enumerate}
...
\item Kopieren der Dateien \path{tlisp.fs} und \path{*.lsp} nach
      \path{/storage/extSdCard/tlisp}
\item Erzeugen von \path{/storage/sdCard0/gforth/home/.gforthrc} mit
      folgendem Inhalt:
        \begin{verbatim}
        ...
        ;
        \end{verbatim}
      Ab Gforth Version \href{https://github.com/forthy42/gforth/releases/tag/0.7.9_20180905}{0.7.9\_20180905}
      heißt diese Datei \path{~/.config/gforthrc} statt \path{~/.gforthrc} (Poettering-Stil).
\end{enumerate}
